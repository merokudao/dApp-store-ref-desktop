            ...
            <div className="flex flex-col">
                ...
                <section>
                    <header className="z-10 flex flex-col md:flex-row md:justify-between md:items-end gap-4 px-[8px] lg:px-[16px]">
                        ...
                        <div className="flex-initial flex h-10" >
                            <Button as="a" className="flex  flex-grow justify-center" target="_blank"
                                href={viewLink}>
                                <div className="text-[12px] mx-2 lg:text-[14px] font-[500]">{AppStrings.visitDapp}</div>
                            ...
                            <a className="m-10" target="_blank" href={`https://twitter.com/intent/tweet?text=Hey%2C%20I%20found%20this%20amazing%20dapp%2C%20check%20it%20out%20${HOST_URL}${router.asPath}`} className="p-4 font-[600] text-[14px]">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <DownloadButton className="m-10" href={downloadLink} dApp={dApp} />
                        </div>
                    </header>
